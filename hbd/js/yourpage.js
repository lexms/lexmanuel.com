...
var i = 0;
function change() {
  var doc = document.getElementById("yourpage");
  var color = ["pink", "khaki", "lavender", "lightcoral","lightgreen"];
...
setTimeout(function () {      
  $('#yourpage').css("background-color", "lavender");
}, 17000);
setTimeout(function () {
  $('.6th').fadeIn()      
...
setTimeout(function () {      
  $('#yourpage').css('background-color', 'pink');
}, 25500);
